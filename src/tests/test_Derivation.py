...
class TestDerivation(unittest.TestCase):
    ...
    def test_adv_979_2(self):
        """ Проверка правила 979. """
        results = self.derivation.derive(word_b='медвежий', pos_b='adj2', pos_a='adv')
        self.assertIn('медвежьи', results)
        results = self.derivation.derive(word_b='бабий', pos_b='adj2', pos_a='adv')
    ...
    def test_adv_992(self):
        ...
        results = self.derivation.derive(word_b='хотя', pos_b='verb1', pos_a='adv')
    ...
    def test_adv_994_2(self):
        results = self.derivation.derive(word_b='птичий', pos_b='adj2', pos_a='adv')
        self.assertIn('по-птичьему', results)
        results = self.derivation.derive(word_b='твой', pos_b='adj2', pos_a='adv')
